import style from './PreviewWork.module.scss';
...
function PreviewWork(props: Props) {
    let slides: [] = [];
            ...
            <div className={style.preview_body}>
                <div>
                    <div className={style.image_block}>
                        <ImageSlider slides={slides} width={380} height={300}></ImageSlider>
                    </div>
                ...
                <div>
                    <div className={style.text_content}>
                        <h1 className='font-bold text-[22pt] text-left'>{props.current_work.title}</h1>
